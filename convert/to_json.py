...
file_input_content = "../display/fill_braces_result.md"
file_structure = "../display/structure.json"
file_structure_pretty_print = "../display/structure_pretty_print.md"
file_prompt_to_json = "../prompt/prompt_to_json.md"
...
with open(file_prompt_to_json, "r", encoding="utf-8") as f:
    prompt = f.read()
...
try:
    ...
    with open(file_structure, "w", encoding="utf-8") as f:
        f.write(output)
    print("Generated: structure.json")
        
    with open(file_structure_pretty_print, "w", encoding="utf-8") as f:
        f.write(pretty_output)
    print("Generated: structure_pretty_print.json")
